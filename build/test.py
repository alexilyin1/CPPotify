...
class CPPotify:
    ...
    def post_player(self, player_action, device_id = ''):
        if not self.oAuth:
            warnings.warn(
        ...
        call = self._cpp_obj.postPlayer(player_action, device_id)
...
cpp = CPPotify(CLIENT_ID, CLIENT_SECRET, "https://example.com/callback", "34fFs29kd09", "user-read-private,user-read-email")
