...
class CPPotify:
    ...
    def __init__(self, CLIENT_ID, CLIENT_SECRET, REDIRECT_URI = None, STATE = None, SCOPE = None, SHOW_DIALOG: bool = None):
        ...
        if REDIRECT_URI is not None:
            ...
            self._cpp_obj = pybind11module.CPPotify(self.CLIENT_ID, self.CLIENT_SECRET, self.REDIRECT_URI, self.STATE, self.SCOPE, self.SHOW_DIALOG)
